...
import cn.shh.project.reggie.util.SMSUtils;
import cn.shh.project.reggie.util.ValidateCodeUtils;
...
public class UserController {
    ...
    public R<String> sendCode(@RequestBody User user, HttpSession session) {
        // 发送短信验证码并保存验证码
        return userService.sendCode(user.getPhone(), session);
    }
